...
{:origin
 {:year 1979,
  ...
  :machine "mainframe"},
 :career-path
 [{:era "1980s", :focus "FORTH, Embedded Systems, Meta-FORTH"}
  {:era "1990s", :focus "Modula-2, Ada, Pascal, Database"}
  {:era "2000s", :focus "NitroSecurity, McAfee, Intel"}
  {:era "2010s", :focus "Clojure, C++, Scale Indicators"}
  {:era "2020s", :focus "Embedded Systems, Modern C++"}]}
