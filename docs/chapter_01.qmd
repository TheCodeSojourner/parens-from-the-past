...
It was a mission statement as much as a technical goal. Alex had watched programming languages come, go and change over his lifetime. He'd seen FORTRAN, BASIC, APL and FORTH give way to C, <span style="white-space: nowrap;">C++</span>, Java and {{C#}}, then JavaScript and Python. He'd watched object-oriented programming rise to dominance, only to be challenged by more mathematically sound functional approaches. Through it all, embedded C and <span style="white-space: nowrap;">C++</span> had remained an industry defacto standard.
